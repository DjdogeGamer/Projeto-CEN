...
class QuizGame extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(400, 150, this.questions[this.currentQuestion].question, {
            fontFamily: 'Arial',
            fontSize: 18,
            color: '#ffffff',
        ...
        this.add.rectangle(400, 275, 200, 50, 0xffffff)
            .setInteractive()
            .on('pointerdown', () => {}, this)
            .setStrokeStyle(4, 0x000000);

        this.add.text(400, 275, this.questions[this.currentQuestion].choices[0], {fontFamily: 'Arial', fontSize: 24, color: '#000000'}).setOrigin(0.5);

        this.add.rectangle(400, 375, 200, 50, 0xffffff)
            .setInteractive()
            .on('pointerdown', () => {}, this)
            .setStrokeStyle(4, 0x000000);

        this.add.text(400, 375, this.questions[this.currentQuestion].choices[1], {fontFamily: 'Arial', fontSize: 24, color: '#000000'}).setOrigin(0.5);

        this.add.rectangle(400, 475, 200, 50, 0xffffff)
            .setInteractive()
            .on('pointerdown', () => {}, this)
            .setStrokeStyle(4, 0x000000);

        this.add.text(400, 475, this.questions[this.currentQuestion].choices[2], {fontFamily: 'Arial', fontSize: 24, color: '#000000'}).setOrigin(0.5);
    ...
    showNextQuestion() {
        if (this.currentQuestion >= this.questions.length) {
            ...
            this.add.text(400, 500, 'Fim do quiz! Sua pontuação é: ' + this.score, {
                fontFamily: 'Arial',
                fontSize: 24,
                color: '#000000'
            }).setOrigin(0.5);
